...
class ArchiveDirectory extends Model
{
    use Uuid;
     ...
     * @var string
     */
    protected $table = 'archive_directories';
    ...
    public static function rules($action, $merge = [], $id = null)
    {
        ...
        $rules = [
            ...
            'parentId' => 'required|exists:archive_directories,id',
        ];
        if ($action == 'update') {
    ...
    {
        return $this->hasMany(ArchiveEntry::class, 'parentId');
    }
     ...
     *
     * @param ArchiveDirectory|Checklist $object
     * @return ArchiveEntry
     */
