<!--
@component:         ElementAuditContainer
@environment:       Hyprid
@description:       -
            ...
            <div class="checklist__element-headline">
                <slot name="title">
                    ...
                    <div class="checklist__element-headline-inner">
                        <!-- Section -->
                        <span v-if="data.objectType === 'section'">
                        ...
                        <!-- Textfield -->
                        <span v-if="data.objectType === 'textfield' && data.object.fixed">
                        ...
                        <!-- Picture -->
                        <span v-if="data.objectType === 'picture' && data.object.type === 'media'">
                        ...
                        <!-- Signature -->
                        <span v-if="data.objectType === 'picture' && data.object.type === 'signature'">
                        ...
                        <!-- Location -->
                        <span v-if="data.objectType === 'location'">
                        ...
                        <!-- Participant -->
                        <span v-if="data.objectType === 'participant'">
...
<script>
import ElementAuditCheckpoint from '@/components/Element/ElementAuditCheckpoint';
import ElementAuditSection from '@/components/Element/ElementAuditSection';
...
export default {
	name: 'ElementAuditContainer',

	components: {
		ElementAuditCheckpoint,
		ElementLocation,
		ElementParticipant,
		ElementPicture,
	...
	methods: {
		getComponentName(objectType) {
			...
			switch (objectType) {
				case 'section':
					result = 'ElementAuditSection';
					break;
				case 'checkpoint':
					result = 'ElementAuditCheckpoint';
					break;
				case 'textfield':
