<template>
	<div class="view__renew-password">
                ...
                <el-card>
                    ...
                    <div class="p-l-1 p-r-1">
                        <div v-if="hasToken">
                            ...
                            <FormRenewPassword :token="token" class="m-t-1" />
                        </div>
                        <div v-else>
                            <el-alert
                                :title="$t('ERROR')"
...
<script>
import FormRenewPassword from '@/components/Form/FormRenewPassword';
