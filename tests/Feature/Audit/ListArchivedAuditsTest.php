...
class ListArchivedAuditsTest extends TestCase
{
    ...
    public function testInvalidAccess($userKey, $companyIdKey, $statusCode)
    {
        ...
        if ($companyIdKey === 'company') {
            $uri = '/audits/archive/company/' . $this->user->company->id;
        } else {
            $uri = '/audits/archive/company/' . Uuid::uuid4()->toString();
        }
    ...
    public function testValidAccess($userKey, $companyKey, $expectEmpty)
    {
        ...
        if ($companyKey === 'company') {
            ...
            $uri = '/audits/archive/company/' . $this->otherUser->company->id;
        }
