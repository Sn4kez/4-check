...
class UpdateArchiveDirectoryTest extends TestCase
{
    use DatabaseMigrations;

    /**
     * @var \App\ArchiveDirectory $directory
     */
    protected $directory;
    ...
    public function setUp()
    {
        ...
        $this->otherDirectory = $this->makeFakeArchiveDirectory(['with_description']);
        $this->otherDirectory->save();
        $this->company->archive->entry($this->otherDirectory)->save();
    }
    ...
    public function testValidEntities($userKey, $attribute, $dbAttribute, $value)
    {
        ...
        $this->json('PATCH', '/archives/' . $this->directory->id, $data);
