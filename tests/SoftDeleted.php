...
class SoftDeleted extends Constraint
{
    /**
    ...
    /**
     * The column that will be used to check for soft delete timestamps.
     *
     * @var string
     */
    protected $column;
     ...
     * @param string $column
     */
    public function __construct(Connection $database, array $data, string $column = 'deleted_at')
    {
        parent::__construct();
        $this->data = $data;
